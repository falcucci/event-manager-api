...
class AccountTestCase(APITestCase):
    ...
    def test_register_user(self):
        ...
        response = self.client.post(f'{self.host}/api/auth/register', new_user)
    ...
    def test_login(self):
        response = self.client.post(f'{self.host}/api/auth/login', {"username": "super_test", "password": "super@test_123"})
